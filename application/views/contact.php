    ...
    <div class="row container-fluid ">
        ...
        <div class="d-flex flex-column justify-content-center p-4 mt-4 align-items-center">
            ...
            <div class="d-flex align-items-center contact">
                ...
                <div class="col-8 p-2">
                    <div class="div">
                        <h4>Omahbata Cibinong</h4>
                        <p>Jl. Raya Jakarta-Bogor No.KM.41, RT. 001/RW, Pabuaran, Cibinong, Kota Bogor, Jawa Barat 16916</p>
                        <i class="fab fa-whatsapp fa-lg"></i> 0812-8201-414
                    </div>
                </div>
                <div class="row" style="margin-top: 250px; margin-left: -110px;">
                    <button class="d-flex gap-2 btn tombol btn-lg rounded-0 px-5 py-3">Maps <i class="fas fa-arrow-right"></i></button>
                </div>
            </div>
